...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<User.Empty,
      User.LoginResponse> getLogoutMethod;
  ...
  public static io.grpc.MethodDescriptor<User.Empty,
      User.LoginResponse> getLogoutMethod() {
    io.grpc.MethodDescriptor<User.Empty, User.LoginResponse> getLogoutMethod;
    if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLogoutMethod = userGrpc.getLogoutMethod) == null) {
          userGrpc.getLogoutMethod = getLogoutMethod =
              io.grpc.MethodDescriptor.<User.Empty, User.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractBlockingStub<userBlockingStub> {
    ...
    /**
     */
    public User.LoginResponse logout(User.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractFutureStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<User.LoginResponse> logout(
        User.Empty request) {
      return futureUnaryCall(
